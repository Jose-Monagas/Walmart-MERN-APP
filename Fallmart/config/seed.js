...
(async function () {
	...
	const products = await Product.create([
		{
			...
			reviews: [
				'These apples are incredibly fresh and delicious. I buy them every week!'
			]
		}, // 0 - Fruits
		{
			name: 'Shampoo',
			...
			reviews: [
				"I love this shampoo! It's gentle on my hair and leaves it feeling nourished."
			]
		}, // 1 - Hair Care
		{
			name: 'Smartphone',
			...
			reviews: [
				'This smartphone is amazing! It has all the advanced features I need.'
			]
		}, // 2 - Mobile Phones
		{
			name: 'Sofa',
			...
			reviews: [
				'The sofa is not only comfortable but also adds a touch of style to my living room. Love it!'
			]
		}, // 3 - Living Room Furniture
		{
			...
			reviews: [
				"My furry friend can't get enough of this nutritious dog food. It keeps them healthy and happy!"
			]
		}, // 4 - Pet Food
		{
			name: 'Baby Diapers',
			...
			reviews: [
				'These diapers are soft and absorbent, perfect for my little one. No leaks!'
			]
		}, // 5 - Diapers
		{
			name: 'T-Shirt',
			...
			reviews: [
				'The T-shirt is comfortable and fits perfectly. Great for everyday wear!'
			]
		}, // 6 - Casual Wear
		{
			name: 'Orange Juice',
			...
			reviews: [
				'This orange juice is so fresh and delicious. Its a great way to start my mornings!'
			]
		}, // 7 - Beverages
		{
			name: 'Toothpaste',
			...
			reviews: [
				'Ive been using this toothpaste for years. It keeps my teeth healthy and my breath fresh!'
			]
		}, // 8 - Oral Care
		{
			name: 'Laptop',
			...
			reviews: [
				'This laptop is a beast! It handles all my tasks with ease, and gaming on it is fantastic!'
			]
		}, // 9 - Computers
		{
			name: 'Coffee Table',
			...
			reviews: [
				'I love this coffee table. Its not only functional but also adds an elegant touch to my living room decor!'
			]
		}, // 10 - Office Furniture
		{
			name: 'Cat Food',
		...
		}, // 11 - Pet Food
		{
			...
			reviews: [
				'These baby wipes are so gentle on my babys skin. They make diaper changes a breeze!'
			]
		}, // 12 - Wipes
		{
			name: 'Dress Shirt',
			...
			reviews: [
				'The dress shirt is elegant and fits perfectly. Its my go-to for formal events!'
			]
		}, // 13 - Formal Wear
		{
			name: 'Bananas',
			...
			reviews: [
				'These bananas are always fresh and sweet. My kids love them as a snack!'
			]
		}, // 14 - Fruit
		{
			name: 'Conditioner',
			...
			reviews: [
				'This conditioner leaves my hair silky and smooth. I cant live without it!'
			]
		}, // 15 - Hair Care
		{
			name: 'Tablet',
			...
			reviews: [
				'The tablet is versatile and lightweight. Its perfect for both work and entertainment!'
			]
		}, // 16 - Tablets
		{
			name: 'Desk',
			...
			reviews: [
				'I love this desk for my home office. It has plenty of space and helps me stay organized!'
			]
		}, // 17 - Office Furniture
		{
			name: 'Cat Litter',
			...
			reviews: [
				'This cat litter really helps control odors. It makes cleaning the litter box a less smelly task!'
			]
		}, // 18 - Pet Food
		{
			name: 'Baby Formula',
			...
			reviews: [
				'This baby formula is great for my infant. It provides all the nutrients they need!'
			]
		}, // 19 - Diapers
		{
			name: 'Jeans',
			...
			reviews: [
				'These jeans are so comfortable and durable. Theyre my favorite for casual wear!'
			]
		}, // 20 - Casual Wear
		{
			name: 'Peaches',
			...
			reviews: [
				'These peaches are incredibly juicy and flavorful. They make a delicious snack!'
			]
		}, // 21 - Fruits
		{
			name: 'Deodorant',
			...
			reviews: [
				'This deodorant keeps me fresh all day, and the scent is delightful!'
			]
		}, // 22 - Antiperspirants
		{
			...
			reviews: [
				'The Bluetooth speaker is compact and has excellent sound quality. I love it!'
			]
		}, // 23 - Speakers
		{
			name: 'Cereal',
			...
			reviews: [
				"This cereal is my go-to breakfast choice. It's healthy and delicious!"
			]
		},
		{
			name: 'Running Shoes',
			...
			reviews: [
				'These running shoes are so comfortable, and they provide excellent support for my workouts.'
			]
		}, // 25 - Footwear
		{
			name: 'Digital Camera',
			...
			reviews: [
				'This digital camera takes stunning photos and is perfect for photography enthusiasts!'
			]
		}, // 26 - Electronics
		{
			name: 'Desk Chair',
			...
			reviews: [
				'This desk chair is so comfortable, and it supports my back during long work hours.'
			]
		}, // 27 - Office Furniture
		{
			name: 'Fish Food',
			...
			reviews: [
				'My fish love this food. It keeps them healthy and their colors vibrant!'
			]
		}, // 28 - Pet Food
		{
			name: 'Sunscreen',
			...
			reviews: [
				'I use this sunscreen whenever I go outdoors, and it provides great sun protection.'
			]
		}, // 29 - Skin Care
		{
			name: 'Backpack',
			...
			reviews: [
				'This backpack is rugged and spacious, making it perfect for hiking and camping trips.'
			]
		}, // 30 - Outdoor Gear
		{
			name: 'Wristwatch',
			...
			reviews: [
				"I love this wristwatch. It's not only functional but also adds a touch of elegance to my outfits."
			]
		}, // 31 - Accessories
		{
			name: 'Yoga Mat',
			...
			reviews: [
				'This yoga mat is non-slip and comfortable, making my yoga sessions enjoyable.'
			]
		}, // 32 - Fitness
		{
			name: 'Headphones',
			...
			reviews: [
				'These headphones provide excellent sound quality, and I use them for both music and gaming.'
			]
		},
		{
			// 33 - Audio
		...
		}, // 34
		{
			...
			reviews: [
				'I always keep a variety of canned sodas in my fridge. Great for any occasion!'
			]
		}, // 35
		{
			name: 'Body Wash',
			...
			reviews: [
				'This body wash has a great scent and leaves my skin feeling fresh.'
			]
		}, // 36
		{
			name: 'Toothbrush',
			...
			reviews: [
				'My teeth feel so clean after using this toothbrush. Highly recommended!'
			]
		}, // 37
		{
			name: 'Granola Bars',
			...
			reviews: [
				"These granola bars are my go-to snack. They're delicious and nutritious!"
			]
		}, // 38
		{
			...
			description: 'Smooth and hydrating hair conditioner.',
			reviews: [
				"This conditioner leaves my hair silky and smooth. I can't live without it!"
			]
		}, // 39
		{
			name: 'Canned Soup',
			...
			reviews: [
				'These canned soups are a lifesaver on busy days. They taste homemade!'
			]
		}, // 40
		{
			name: 'Face Wash',
			...
			reviews: [
				'My skin feels so fresh and clean after using this face wash. Highly recommended!'
			]
		}, // 41
		{
			name: 'Desk Lamp',
			...
			reviews: [
				'This desk lamp provides great lighting for my workspace. I love it!'
			]
		}, // 42
		{
			name: 'Android',
		...
		}, // 43
		{
			...
			reviews: [
				"I upgraded to this smartphone, and it's a powerhouse. Superb performance!"
			]
		}, // 44
		{
			name: 'Galaxy',
			...
			reviews: [
				"The best smartphone I've ever owned. It's a technological marvel!"
			]
		}, // 45
		{
			name: 'FlipPhone',
	...
	const subcategories = await SubCategory.create([
		...
		{
			name: 'Hair Care',
			products: [products[1]._id, products[39]._id, products[15]._id]
		}, // Personal Care - 1
		{
			name: 'Mobile Phones',
			products: [
		...
		{
			name: 'Antiperspirants & Fitness',
			products: [products[22]._id, products[32]._id]
		}, // Personal Care - 14
